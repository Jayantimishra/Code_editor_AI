    ...
    <>
      ...
      >
        <div className="flex flex-row justify-center items-start gap-4">
          <Button
            variant={"outline"}
            className="flex justify-center items-center bg-white group-hover:bg-[#e3f2f8] group-hover:border-[#25bb9f] group-hover:text-[#097561] transition-colors duration-300"
            size={"icon"}
          >
            <Plus
              size={30}
          ...
          <div className="flex flex-col">
            <h1 className="text-xl font-bold text-[#25bb9f]">Add New</h1>
